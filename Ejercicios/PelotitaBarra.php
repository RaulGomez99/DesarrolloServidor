    ...
    <body>
        ...
        <h1>
            ...
            $tamanoBarra = 3;
                ...
                $barraX= rand (1,$tamañoMapa-$tamanoBarra-2);
            ...
            do
            {
                ...
                if($barraX+$direccionBarraX>$tamañoMapa-$tamanoBarra || $barraX+$direccionBarraX==-1){
                    $direccionBarraX*=-1;
                }
                if($pelotaY+$direccionY==$tamañoMapa-1 && ($pelotaX+$direccionX)>=($barraX+$direccionBarraX) &&  ($pelotaX+$direccionX)<=($barraX+$direccionBarraX+$tamanoBarra)){
                    $contador++;
                    $direccionY*=-1;
                }
                ...
                if($pelota2Y+$direccion2Y==$tamañoMapa-1 && ($pelota2X+$direccion2X)>=($barraX+$direccionBarraX) &&  ($pelota2X+$direccion2X)<=($barraX+$direccionBarraX+$tamanoBarra)){
                    $contador++;
                    $direccion2Y*=-1;
                }
                ...
                if($pelota3Y+$direccion3Y==$tamañoMapa-1 && ($pelota3X+$direccion3X)>=($barraX+$direccionBarraX) &&  ($pelota3X+$direccion3X)<=($barraX+$direccionBarraX+$tamanoBarra)){
                    $contador++;
                    $direccion3Y*=-1;
                }
                ...
                for ($y=0; $y<$tamañoMapa; $y++)
                {
                    for ($x=0; $x<$tamañoMapa; $x++)
                    {
                        ...
                        elseif($x>=$barraX && $x<$barraX+$tamanoBarra && $y==$tamañoMapa-1){
                            echo '<span class="paloma">=</span>';
                        }
                        else
                        {
                ...
                echo "</pre><span>pelotaX=$pelotaX pelotaY=$pelotaY <br>pelota2X=$pelota2X pelota2Y=$pelota2Y <br>pelota3X=$pelota3X pelota3Y=$pelota3Y</span> <br>rebotes=$contador<br>BarraX=$barraX</div>\n";
            } while ($contador<18 );
            ?>   
